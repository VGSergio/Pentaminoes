...
public class GUI extends JFrame{
    ...
    public GUI() {
        ...
        StatusMessageCheckBox.setState(true);   //Optimal performance by default
    }
    ...
    private void initComponents() {
        ...
        StatusMessageCheckBox.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                StatusMessageCheckBoxStateChanged(evt);
            }
        });
    ...
    private void StatusMessageCheckBoxStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_StatusMessageCheckBoxStateChanged
        Board.setStatusMessage(StatusMessageCheckBox.getState());
        TabbedPane.requestFocus();      //Returns focus to the keyevent listener component
    }//GEN-LAST:event_StatusMessageCheckBoxStateChanged
    ...
    private void resetSolutions(){
        ...
        for (Component cmpnt : aux) {
            if(cmpnt instanceof Pentominoes.Board) {
    ...
    private void showSolution(Board board){
        ...
        for (Component cmpnt : aux) {                       //on the solution panel
            if(cmpnt instanceof Pentominoes.Board){         //if there was another 
    ...
    private void ResetBoard(int row, int column){
        ...
        try {               
            sleep(1);                       //Wait for a proper status message update
